...
int main()
{
     ...
     int number{10};
     cout << "no show base and uppercase" << endl;
     cout << noshowbase;
     cout << uppercase;
     ...
     cout << "show base and no uppercase" << endl;
     cout << showbase;
     cout << nouppercase;
     cout << "dec: " << dec << number << endl;
     cout << "oct: " << oct << number << endl;
     ...
     cout << "fixed and scientific" << endl;
     cout << a << endl
          << b << endl
          << c << endl;
     ...
     cout << "show point and no show point" << endl;
     double points = 12.0;
     cout << showpoint;
     cout << points << endl;
     cout << noshowpoint;
